...
const pricingPlans: PricingPlan[] = [
  {
    name: 'Launch Package',
    price: '$1990',
    pricePeriod: '/Design only',
    description: 'Get research-backed, responsive UI/UX designs with unlimited revisions and developer handoff.',
    features: [
      { text: 'UX research', included: true },
      { text: 'High-fidelity designs', included: true },
      { text: 'Responsive Design', included: true },
      { text: 'Figma Prototype', included: true },
  ...
  },
  {
    name: 'Growth Package',
    price: '$2,990',
    pricePeriod: 'Design + Development',
    description: 'Launch your full website with design + development, hosting, analytics, and 2 months maintenance.',
    features: [
      { text: 'Everything from Launch', included: true },
      { text: 'Design Documentation', included: true },
      { text: 'Framer/ Web flow/Wordpress  Development', included: true },
      { text: 'Hosting & Domain Setup', included: true },
  ...
  },
  {
    ...
    price: '$3,990',
    pricePeriod:'design  + Dev + Branding',
    description: 'Go premium with full design, development, branding, SEO, and 3 months maintenance.',
    features: [
      { text: 'Unlimited users', included: true },
      { text: 'Custom automation & SSO', included: true },
